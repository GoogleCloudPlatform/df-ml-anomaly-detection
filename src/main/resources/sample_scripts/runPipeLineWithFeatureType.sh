...
# By default LABEL_DETECTION is set if no featureType parameter is used  
# Below configuration will only select description and score columns from api response
SELECTED_COLUMNS='{\"selectedColumns\":[{\"labelAnnotations\":\"description,score\"}]}'
